...
// Copied from Uniswap/v4-periphery src/hooks/permissionedPools/interfaces/IPermissionsAdapterFactory.sol
// at commit dce236d4e2057422d0791d9a973a58765eb46f65 (main, 2026-08-20), identical at 3245c3cb99c48fa1dc2459c3b60abc37d4294aba.
// One change: IERC20 is imported from OpenZeppelin directly instead of via IPermissionsAdapter.sol,
// which would pull in v4-core (IHooks). ABI unchanged.
