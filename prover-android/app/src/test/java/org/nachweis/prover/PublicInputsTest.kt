...
class PublicInputsTest {
    ...
    fun decodesDesktopLayout() {
        val subject = Codec.hex("f99edde971f4e9c88715a79ca78963284a2955dc")
        val hash = Codec.hex("78cf23963b47d3e393c79ea091c4ed80ebbae4ff78992058dd92fd34e1635183")
        val nonce = Codec.hex("306863157ddb59f4e5a56f41aa8591e68b574c8c3475c43d9bd469220be90762")
