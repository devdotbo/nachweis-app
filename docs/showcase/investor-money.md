...
| Route and registry | `app/src/App.tsx` (:94 to :103, `/showcase/:slug`), `app/src/showcase/registry.ts` | One line per demo; the component loads lazily. |
