...
| 2.2 | `cd $W/contracts && forge test` | `155 tests passed, 0 failed, 20 skipped` (the 20 are fork tests, skipped without `SEPOLIA_RPC_URL`) | verified 2026-09-12 on main `0f200f9`: 155 passed, 0 failed, 20 skipped (2026-09-09 on main `56424b4`: 152 passed, 0 failed, 20 skipped; 2026-09-07 on `wp9c-consistency`: 87 passed, 10 skipped) |
...
On camera, in Chrome on the Mac: Connect dev signer; Create presentation request (the dev signer signs the session); "Prove in this browser" (the QR appears); scan it with the official test wallet on the iPhone, consent; the tab decrypts and proves (the worker proves in about 11 s and verifies in 4 s; scan to attested about 40 s on Sepolia, 2026-09-12, `docs/evidence/sepolia-phone-2026-09-12.md`) and shows "attested from this browser"; switch to Issuer, Approve; back to Investor, Subscribe, the FundToken balance rises. What the tab sends and to which host, the evidence to record, the fail branches and the smoke test without the phone are in `docs/browser-real-wallet.md`.
...
3. Phone: scan the QR with the official test wallet, consent, present. Caption here: "official test wallet, sample identity". The tab walks relay status responded, pickup, checking, witness, init, proving, verifying, submitting, submitted (about 40 s from pickup to attested on Sepolia, 2026-09-12) and ends on "attested from this browser".
...
Deployment exists: `scripts/sepolia-deploy.sh` ran on Sepolia (chain id 11155111) on 2026-09-10, 33 transactions in blocks 11676804 to 11676836, every receipt status 1; the record is `docs/deployments/sepolia-2026-09-10.md` (addresses, transaction hashes with Etherscan links, gas, the env lines below, the on-chain checks). Not verified on Etherscan (no API key). The journey on this deployment (no phone, attest by operator) is recorded in [`docs/evidence/sepolia-journey-2026-09-10.md`](evidence/sepolia-journey-2026-09-10.md). Phone leg recorded 2026-09-12: [`docs/evidence/sepolia-phone-2026-09-12.md`](evidence/sepolia-phone-2026-09-12.md) (official wallet, proof in the browser, `attestWithProof` on Sepolia, then approve, subscribe, swap, revoke and the refused swap on a fresh investor). The concrete command for the stack against that deployment:
...
| `forge build`, `forge test` | verified on `wp9c-consistency` (TODO-1 fixed on main by `1162f2f`): 87 passed, 10 skipped; on main `56424b4` (2026-09-09): 152 passed, 20 skipped; on main `0f200f9` (2026-09-12): 155 passed, 0 failed, 20 skipped |
