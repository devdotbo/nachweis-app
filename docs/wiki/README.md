...
Source: wiki repository at commit `5a5156df018260d1a20dcaa0f8f827550c5f2353` (2026-09-10 21:21:30 +0200), copied on 2026-09-10 with `bun scripts/wiki-copy.ts <wiki checkout> 5a5156d` from the repository root. The script reads each page with `git show <commit>:<path>`, so the copy is the committed content and not a working tree; it then applies the redactions and link rewrites listed below. The layout is flattened: the wiki's `AGENTS.md`, `index.md`, `log.md` and `wiki/<page>.md` sit side by side here, `wiki/privy-cases/` is `privy-cases/`. Every one of the wiki's 49 pages is copied. Not copied: `raw/` (copied research memos, see "What is withheld and why"), the session transcripts (`.txt`), `CLAUDE.md` (a one-line pointer to `AGENTS.md`) and `llm-wiki.md` (the third-party pattern text the wiki layout follows).
...
7. The prompts given to agents, in order: `handoff-astra.md` (WP4, WP5), `handoff-fable-2026-09-08.md` (independent review and work order), `handoff-fable-2026-09-09.md`, `handoff-fable-2026-09-10.md`, `handoff-2026-09-10-morning.md`, `handoff-2026-09-11-morning.md`.
...
| `wiki/architecture.md`, `wiki/checkin-2026-09-08.md`, `wiki/checkin-2026-09-11.md`, `wiki/decisions.md`, `wiki/handoff-2026-09-10-morning.md`, `wiki/handoff-2026-09-11-morning.md`, `wiki/handoff-astra.md`, `wiki/handoff-fable-2026-09-08.md`, `wiki/handoff-fable-2026-09-09.md`, `wiki/handoff-fable-2026-09-10.md`, `wiki/identity-standards-notes.md`, `wiki/identity-standards.md`, `wiki/name-and-domains.md`, `wiki/narrative-zk.md`, `wiki/open-questions.md`, `wiki/pitch-toolkit.md`, `wiki/pitch.md`, `wiki/product.md`, `wiki/repos.md`, `wiki/review-fable-2026-09-09.md`, `wiki/review-morning-2026-09-10.md`, `wiki/review-product-focus-2026-09-09.md`, `wiki/showcase-brief.md`, `wiki/spec-privy.md`, `wiki/sponsors.md`, `wiki/submission-checklist.md`, `wiki/submission-text.md`, `wiki/track-decision.md`, `wiki/uniswap-feedback-form.md`, `wiki/video-shotlist-spine.md`, `wiki/work-packages.md`, `wiki/zk-plan.md`, `wiki/zkpassport.md` | without the `wiki/` prefix |
