...
Source: wiki repository at commit `c7e33b833ca3b620d9972519cd96383c59759789` (2026-09-12 13:04:32 +0200, "Decisions and log 2026-09-12 afternoon: alignment audit merged, sanitization, secret scan, private push (hashes pending)"), copied on 2026-09-12 with `bun scripts/wiki-copy.ts <wiki checkout> c7e33b8` from the repository root. The script reads each file with `git show <commit>:<path>`, so the copy is the committed content and not a working tree; it then applies the redactions and link rewrites listed below. The layout: the wiki's `AGENTS.md`, `CLAUDE.md`, `index.md`, `log.md` and `wiki/<page>.md` sit side by side here, `wiki/privy-cases/` is `privy-cases/`, and `raw/` keeps its name. 67 files are copied (4 root pages, 48 pages under `wiki/`, 15 files under `raw/`). `bun scripts/wiki-coverage.ts <wiki checkout> c7e33b8` checks that every file of the wiki at that commit is either here or listed under "Not copied", and that nothing stale remains.
...
7. The prompts given to agents, in order: `handoff-astra.md`, `handoff-fable-2026-09-08.md`, `handoff-fable-2026-09-09.md`, `handoff-fable-2026-09-10.md`, `handoff-2026-09-10-morning.md`, `handoff-2026-09-11-morning.md`, `handoff-2026-09-12.md`.
...
| `wiki/architecture.md`, `wiki/checkin-2026-09-08.md`, `wiki/checkin-2026-09-11.md`, `wiki/decisions.md`, `wiki/handoff-2026-09-10-morning.md`, `wiki/handoff-2026-09-11-morning.md`, `wiki/handoff-2026-09-12.md`, `wiki/handoff-astra.md`, `wiki/handoff-fable-2026-09-08.md`, `wiki/handoff-fable-2026-09-09.md`, `wiki/handoff-fable-2026-09-10.md`, `wiki/identity-standards-notes.md`, `wiki/identity-standards.md`, `wiki/name-and-domains.md`, `wiki/narrative-zk.md`, `wiki/open-questions.md`, `wiki/pitch-toolkit.md`, `wiki/pitch.md`, `wiki/product.md`, `wiki/repos.md`, `wiki/review-fable-2026-09-09.md`, `wiki/review-morning-2026-09-10.md`, `wiki/review-product-focus-2026-09-09.md`, `wiki/review-readiness-2026-09-11.md`, `wiki/showcase-brief.md`, `wiki/spec-privy.md`, `wiki/sponsors.md`, `wiki/submission-checklist.md`, `wiki/submission-text.md`, `wiki/track-decision.md`, `wiki/uniswap-feedback-form.md`, `wiki/video-shotlist-spine.md`, `wiki/work-packages.md`, `wiki/zk-plan.md`, `wiki/zkpassport.md` | without the `wiki/` prefix |
...
Everything else in the wiki at the pinned commit is here. The wiki's git history is private and stays private; this copy is a snapshot of one commit, and the earlier snapshots (commits `5f6271e` taken 2026-09-09, `5a5156d` taken 2026-09-10, `6a79c66` taken 2026-09-11, `cb061eb` and `457e986` taken 2026-09-12) are in this repository's history.
