...
- Make devdotbo/nachweis-site public (or hold a GitHub Pro plan), enable Pages, set the custom domain, add the DNS records at Porkbun, enforce HTTPS: the exact order is in nachweis-site/docs/hosting.md. Verification of the live site (curl of https://attestat.dev) happens after that; unverified until then.
