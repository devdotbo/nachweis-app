...
#if canImport(prover_mobile_coreFFI)
import prover_mobile_coreFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_prover_mobile_core_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_prover_mobile_core_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureProverMobileCoreInitialized()
 ...
 * outputs.
 */
public struct DerivedInputs: Equatable, Hashable {
    public var proverToml: String
    public var witness: [String]
    public var issuerKeyHashHex: String
    public var over18: UInt8
    ...
    public init(proverToml: String, witness: [String], issuerKeyHashHex: String, over18: UInt8, expiry: UInt64, nonceHex: String, subjectHex: String, 
        ...
        self.proverToml = proverToml
        self.witness = witness
        self.issuerKeyHashHex = issuerKeyHashHex
        self.over18 = over18
        self.expiry = expiry
...
#if compiler(>=6)
extension DerivedInputs: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeDerivedInputs: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> DerivedInputs {
        return
            try DerivedInputs(
                proverToml: FfiConverterString.read(from: &buf), 
                witness: FfiConverterSequenceString.read(from: &buf), 
                issuerKeyHashHex: FfiConverterString.read(from: &buf), 
                over18: FfiConverterUInt8.read(from: &buf), 
    ...
    public static func write(_ value: DerivedInputs, into buf: inout [UInt8]) {
        FfiConverterString.write(value.proverToml, into: &buf)
        FfiConverterSequenceString.write(value.witness, into: &buf)
        FfiConverterString.write(value.issuerKeyHashHex, into: &buf)
        FfiConverterUInt8.write(value.over18, into: &buf)
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeDerivedInputs_lift(_ buf: RustBuffer) throws -> DerivedInputs {
    return try FfiConverterTypeDerivedInputs.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeDerivedInputs_lower(_ value: DerivedInputs) -> RustBuffer {
    return FfiConverterTypeDerivedInputs.lower(value)
}
...
public struct ProofResult: Equatable, Hashable {
    ...
    public init(
        ...
        /**
         * 86 x 32 bytes, in verifier order; concatenated it is bb's `public_inputs` file.
         */publicInputs: [Data], executeMs: UInt64, proveMs: UInt64, 
        /**
         * Peak resident set size of the process after proving, bytes (0 if unknown).
         */peakRssBytes: UInt64) {
        self.proof = proof
...
public struct FfiConverterTypeProofResult: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ProofResult {
        return
            try ProofResult(
                ...
                executeMs: FfiConverterUInt64.read(from: &buf), 
                proveMs: FfiConverterUInt64.read(from: &buf), 
                peakRssBytes: FfiConverterUInt64.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: ProofResult, into buf: inout [UInt8]) {
        ...
        FfiConverterUInt64.write(value.executeMs, into: &buf)
        FfiConverterUInt64.write(value.proveMs, into: &buf)
        FfiConverterUInt64.write(value.peakRssBytes, into: &buf)
    }
}
 ...
 */
public func circuitDyadicSize(circuitJsonPath: String)throws  -> UInt32  {
    return try  FfiConverterUInt32.lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
        uniffiCallStatus in
    uniffi_prover_mobile_core_fn_func_circuit_dyadic_size(
        FfiConverterString.lower(circuitJsonPath),uniffiCallStatus
    )
})
}
/**
 ...
 */
public func computeVerificationKey(circuitJsonPath: String, srsPath: String, onChain: Bool)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
        uniffiCallStatus in
    uniffi_prover_mobile_core_fn_func_compute_verification_key(
        FfiConverterString.lower(circuitJsonPath),
        FfiConverterString.lower(srsPath),
        FfiConverterBool.lower(onChain),uniffiCallStatus
    )
})
}
 ...
 */
public func prove(circuitJsonPath: String, srsPath: String, vk: Data, witness: [String], onChain: Bool, lowMemory: Bool)throws  -> ProofResult  {
    return try  FfiConverterTypeProofResult_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
        uniffiCallStatus in
    uniffi_prover_mobile_core_fn_func_prove(
        FfiConverterString.lower(circuitJsonPath),
        FfiConverterString.lower(srsPath),
        FfiConverterData.lower(vk),
        FfiConverterSequenceString.lower(witness),
        FfiConverterBool.lower(onChain),
        FfiConverterBool.lower(lowMemory),uniffiCallStatus
    )
})
}
/**
 ...
 */
public func setupSrs(circuitJsonPath: String, srsPath: String)throws  -> UInt32  {
    return try  FfiConverterUInt32.lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
        uniffiCallStatus in
    uniffi_prover_mobile_core_fn_func_setup_srs(
        FfiConverterString.lower(circuitJsonPath),
        FfiConverterString.lower(srsPath),uniffiCallStatus
    )
})
}
public func verify(proof: Data, publicInputs: [Data], vk: Data, onChain: Bool)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
        uniffiCallStatus in
    uniffi_prover_mobile_core_fn_func_verify(
        FfiConverterData.lower(proof),
        FfiConverterSequenceData.lower(publicInputs),
        FfiConverterData.lower(vk),
        FfiConverterBool.lower(onChain),uniffiCallStatus
    )
})
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_prover_mobile_core_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_prover_mobile_core_checksum_func_circuit_dyadic_size() != 11242) {
    ...
    if (uniffi_prover_mobile_core_checksum_func_setup_srs() != 56134) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_prover_mobile_core_checksum_func_verify() != 31207) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureProverMobileCoreInitialized() {
